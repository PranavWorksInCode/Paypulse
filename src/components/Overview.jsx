...
export default function Overview({ transactions, onNavigateTab }) {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      {/* Hero Welcome Banner */}
      <div className="p-8 rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950/40 to-slate-900 border border-indigo-500/20 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="glass-panel p-6 space-y-3">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-xs font-mono font-semibold uppercase tracking-wider">Processed Volume</span>
        ...
        <div className="glass-panel p-6 space-y-3">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-xs font-mono font-semibold uppercase tracking-wider">Fraud Savings</span>
          ...
          <div className="flex items-center justify-between text-xs font-mono pt-1 text-slate-400">
            <span>{highRiskCount} Threat Attacks</span>
        ...
        <div className="glass-panel p-6 space-y-3">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-xs font-mono font-semibold uppercase tracking-wider">Flagged Anomalies</span>
        ...
        <div className="glass-panel p-6 space-y-3">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-xs font-mono font-semibold uppercase tracking-wider">Inference Speed</span>
      ...
      {/* Recent Stream Snapshot Card */}
      <div className="glass-panel p-6 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-white/10">
          <h3 className="text-base font-bold text-white flex items-center gap-2">
            <Activity className="w-4 h-4 text-indigo-400" />
            <span>Recent Ingestion Snapshot</span>
          </h3>
          <button 
            onClick={() => onNavigateTab('radar')}
        ...
        <div className="space-y-2.5 font-mono text-xs">
          {recentTransactions.map((txn) => (
            <div 
              key={txn.id}
              className="p-3.5 rounded-xl bg-slate-900/60 border border-white/5 flex items-center justify-between hover:bg-slate-900 transition-colors"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-white">{txn.merchant}</div>
