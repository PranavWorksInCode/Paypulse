...
export default function Sidebar({ 
  ...
  const navItems = [
    ...
    { id: 'radar', label: 'Live Stream Radar', icon: ShieldCheck, tag: 'LIVE', tagClass: 'nav-tag-live' },
    ...
    { id: 'rules', label: 'Risk Rule Engine', icon: Sliders },
    { id: 'analytics', label: 'Geo & Merchants', icon: Map }
  ];
